...
public class Main {
    public static void main(String[] args) {
        ...
        Livro livro4 = new Livro("A República", "Platão", 380);
        Livro livro5 = new Livro("Crime e Castigo", "Fiódor Dostoiévski", 1943);
        ...
        Livro livro10 = new Livro("Em Busca de Sentido", "Viktor Frankl", 1980);
